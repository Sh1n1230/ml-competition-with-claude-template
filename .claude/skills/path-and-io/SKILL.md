---
name: path-and-io
description: Use this when reading from or writing to local files — including constructing file paths with pathlib, creating directories, choosing output locations, and using path utilities from src/commons/paths.py.
---
...
- Use the path utilities in `src/commons/paths.py`.
...
```python
from commons.paths import data_dir, outputs_dir, ensure_parent_dir
